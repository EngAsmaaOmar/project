...
public class KfaaElnoonSakinaFragment extends Fragment {
    ...
    @BindView(R.id.img_main_menu_sub_menu)
    ImageView img_main_menu_sub_menu;

    @BindView(R.id.sec_kfaa_noon_txt)
    TextView tvsec_kfaa_noon;
